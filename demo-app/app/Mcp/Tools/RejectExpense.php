...
class RejectExpense extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $event = match (true) {
            $expenseReport->currentState === 'manager_approval' && $user?->can('reject', $expenseReport) => 'reject',
            $expenseReport->currentState === 'finance_review' && $user?->can('financeReject', $expenseReport) => 'finance_reject',
            default => null,
        };
        ...
        $this->revisionGateway->transition($expenseReport->instance, $event);
